...
#
temp1 = sum(kknn_c$eGFR_cyst[which(kknn_c$na_int_group=="group1")]<60,na.rm = T)
pp1 = round(temp1 / sum(!is.na(kknn_c$eGFR_cyst[which(kknn_c$na_int_group=="group1")])),4)*100
paste(temp1," (",pp1,")",sep="")

temp1 = sum(kknn_c$eGFR_cyst[which(kknn_c$na_int_group=="group2")]<60,na.rm = T)
pp1 = round(temp1 / sum(!is.na(kknn_c$eGFR_cyst[which(kknn_c$na_int_group=="group2")])),4)*100
paste(temp1," (",pp1,")",sep="")

temp1 = sum(kknn_c$eGFR_cyst[which(kknn_c$na_int_group=="group3")]<60,na.rm = T)
pp1 = round(temp1 / sum(!is.na(kknn_c$eGFR_cyst[which(kknn_c$na_int_group=="group3")])),4)*100
paste(temp1," (",pp1,")",sep="")

temp1 = sum(kknn_c$eGFR_cyst[which(kknn_c$na_int_group=="group4")]<60,na.rm = T)
pp1 = round(temp1 / sum(!is.na(kknn_c$eGFR_cyst[which(kknn_c$na_int_group=="group4")])),4)*100
paste(temp1," (",pp1,")",sep="")
...
# model9.1 = as.formula("Surv(follow_up_time_minor1, event.type) ~  age1+Sex+economic+
#                       education+Ethnic.1+
#                       smoking+alcohol+physical_activity+K_KAWASAKI+
#                       waist_circumference+hypertension_check+diabetes_check+
#                       CVD_check+stroke_check+Diuretics+ACEI_or_ARB+
...
# # sm9.1t = coxph(formula = Surv(follow_up_time_minor1, event.type) ~ (age1)+Sex+economic+
# #                  (education)+Ethnic.1+
# #                  (smoking)+alcohol+physical_activity+(K_KAWASAKI)+
# #                  (waist_circumference)+(hypertension_check)+(diabetes_check)+
# #                  CVD_check+(stroke_check)+Diuretics+ACEI_or_ARB+
...
# 
# 
# model9.2 = as.formula(paste("Surv(follow_up_time_minor1, event.type) ~ age1+Sex+economic+
#                             education+Ethnic.1+
#                             smoking+alcohol+physical_activity+K_KAWASAKI+
#                             waist_circumference+hypertension_check+diabetes_check+
#                             CVD_check+stroke_check+Diuretics+ACEI_or_ARB+
...
# # sm9.2t = coxph(formula = Surv(follow_up_time_minor1, event.type) ~ (age1)+Sex+economic+
# #                  (education)+Ethnic.1+
...
# publish(sm9.2)
# 
# model9.3 = as.formula(paste("Surv(follow_up_time_minor1, event.type) ~ age1+Sex+economic+
#                             education+Ethnic.1+
#                             smoking+alcohol+physical_activity+K_KAWASAKI+
#                             waist_circumference+hypertension_check+diabetes_check+
#                             CVD_check+stroke_check+Diuretics+ACEI_or_ARB+
...
# # sm9.3t = coxph(formula = Surv(follow_up_time_minor1, event.type) ~ (age1)+Sex+economic+
# #                  (education)+Ethnic.1+
# #                  (smoking)+alcohol+physical_activity+tt(K_KAWASAKI)+
# #                  (waist_circumference)+(hypertension_check)+(diabetes_check)+
# #                  CVD_check+(stroke_check)+Diuretics+ACEI_or_ARB+
...
# 
# 
# model9.4 = as.formula(paste("Surv(follow_up_time_minor1, event.type) ~ age1+Sex+economic+
#                             education+Ethnic.1+
#                             smoking+alcohol+physical_activity+K_KAWASAKI+
#                             waist_circumference+hypertension_check+diabetes_check+
#                             CVD_check+stroke_check+Diuretics+ACEI_or_ARB+
...
# # sm9.4t = coxph(formula = Surv(follow_up_time_minor1, event.type) ~ (age1)+Sex+economic+
# #                  (education)+Ethnic.1+
# #                  (smoking)+alcohol+physical_activity+tt(K_KAWASAKI)+
# #                  (waist_circumference)+(hypertension_check)+(diabetes_check)+
# #                  CVD_check+(stroke_check)+Diuretics+ACEI_or_ARB+
